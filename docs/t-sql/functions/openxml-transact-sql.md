...
|**2**|Use the **element-centric** mapping. Can be combined with XML_ATTRIBUTES. In this case, **element-centric** mapping is applied first, and then **attribute-centric** mapping is applied for all columns not yet dealt with.|  
